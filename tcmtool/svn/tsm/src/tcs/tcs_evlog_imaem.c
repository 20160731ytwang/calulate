...
int
ima_open(void *source, LOG_HANDLE *handle)
{
 	FILE *fd;
...
TSS_RESULT
ima_get_entries_by_pcr(LOG_HANDLE handle, UINT32 pcr_index, UINT32 first,
...
TSS_RESULT
ima_get_entry(LOG_HANDLE handle, UINT32 pcr_index, UINT32 *num, TSS_PCR_EVENT **ppEvent)
{
