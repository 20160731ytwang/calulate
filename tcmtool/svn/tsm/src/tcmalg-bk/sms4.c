...
INT32 Sms4CBC_E(BYTE *IV, BYTE *M, INT32 mLen, BYTE *S, BYTE *pucKey)
{
	...
	while((mLen - i) > 0)
	{
		sms4CBC_xor(tmpM, sms4Buff, sms4Buff, SMS4_BLOCK_SIZE);	//������
		SMS4Enc((UINT32 *)sms4Buff, (UINT32 *)tmpS, &smsKey);	//�ټ���
		memcpy(sms4Buff, tmpS, SMS4_BLOCK_SIZE);				//������һ�ֵļ��ܽ���
...
INT32 Sms4CBC_D(BYTE *IV, BYTE *M, INT32 mLen, BYTE *S, BYTE *pucKey)
{
	...
	while((mLen - i) > 0)
	{
		SMS4Dec((UINT32 *)tmpS, (UINT32 *)tmpM, &smsKey);					//�Ƚ���
		sms4CBC_xor(tmpM, sms4Buff, tmpM, SMS4_BLOCK_SIZE);			//������
		memcpy(sms4Buff, tmpS, SMS4_BLOCK_SIZE);					//������һ�ֽ���
		tmpS = tmpS + SMS4_BLOCK_SIZE;
		tmpM = tmpM + SMS4_BLOCK_SIZE;
		i = i + SMS4_BLOCK_SIZE;
	}
...
INT32 Sms4ECB_E(BYTE *M, INT32 mLen, BYTE *S, BYTE *pucKey)
{
	...
	while((mLen - i) > 0)
	{
		SMS4Enc((UINT32 *)tmpM, (UINT32 *)tmpS, &smsKey);							//����
		tmpS = tmpS + SMS4_BLOCK_SIZE;
		tmpM = tmpM + SMS4_BLOCK_SIZE;
		i = i + SMS4_BLOCK_SIZE;
	}
...
INT32 Sms4ECB_D(BYTE *M, INT32 mLen, BYTE *S, BYTE *pucKey)
{
	...
	while((mLen - i) > 0)
	{
		SMS4Dec((UINT32 *)tmpS, (UINT32 *)tmpM, &smsKey);			//����
		tmpS = tmpS + SMS4_BLOCK_SIZE;
		tmpM = tmpM + SMS4_BLOCK_SIZE;
		i = i + SMS4_BLOCK_SIZE;
	}
...
* func : SMS4_E()
* Input :  
* 		BYTE *IV : IV������Կ����һ����128bits��������ECBģʽ��������0
*		BYTE *M : ���ĵ�ַ
*		UINT32 mLen: ���ĳ���
*		BYTE *S�����ĵ�ַ
* 		BYTE *key : ��Կ
