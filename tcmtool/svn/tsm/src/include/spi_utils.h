...
TSS_RESULT secret_ValidateAuth_OSAP(TSS_HOBJECT, UINT32, TSS_HPOLICY,
				    ...
				    TPM_AUTH *, BYTE *, TCPA_NONCE *);
#endif
TSS_RESULT secret_TakeOwnership(TSS_HKEY, TSS_HTPM, TSS_HKEY, TCM_AUTH_SESSION **,
...
#define TSPI_TCM_TXBLOB_SIZE		2048
...
TSS_RESULT Transport_OSAP(TSS_HCONTEXT, TCPA_ENTITY_TYPE, UINT32, TPM_NONCE *, TCS_AUTHHANDLE *,
			  TCPA_NONCE *, TCPA_NONCE *);
TSS_RESULT RPC_APCreate(TSS_HCONTEXT,TCPA_ENTITY_TYPE,UINT32,TCPA_NONCE,TCPA_AUTHDATA,
			TCS_AUTHHANDLE *,TCPA_NONCE *,TCPA_SEQ *,TCPA_AUTHDATA *);
...
TSS_RESULT RPC_TakeOwnership(TSS_HCONTEXT, UINT16, UINT32, BYTE *, UINT32, BYTE *, UINT32, BYTE *, TCM_AUTH_SESSION *, UINT32 *, BYTE **);
...
struct tcs_api_table {
	...
	TSS_RESULT (*APCreate)(TSS_HCONTEXT,TCPA_ENTITY_TYPE,UINT32,TCPA_NONCE,TCPA_AUTHDATA,
				TCS_AUTHHANDLE *,TCPA_NONCE *,TCPA_SEQ *,TCPA_AUTHDATA *);
#endif
