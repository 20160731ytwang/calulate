...
int ima_open(void *, LOG_HANDLE *);
TSS_RESULT ima_get_entries_by_pcr(LOG_HANDLE, UINT32, UINT32, UINT32 *, TSS_PCR_EVENT **);
TSS_RESULT ima_get_entry(LOG_HANDLE, UINT32, UINT32 *, TSS_PCR_EVENT **);
int ima_close(LOG_HANDLE);
