...
TSS_RESULT auth_mgr_APCreate(TCS_CONTEXT_HANDLE hContext,	/* in */
	      	  	     	TCPA_ENTITY_TYPE entityType,	/* in */
		  	     	UINT32 entityValue,		/* in */
		  		TCPA_NONCE callerNonce,	/* in */
...
void LoadBlob_TCM_Auth(UINT64 *, BYTE *, TCM_AUTH_SESSION *);
void UnloadBlob_TCM_Auth(UINT64 *, BYTE *, TCM_AUTH_SESSION *);
...
TSS_RESULT UnloadBlob_TSM_KEY(UINT64 *, BYTE *, TSS_KEY *);
void LoadBlob_TSM_KEY(UINT64 *, BYTE *, TSS_KEY *);
...
TSS_RESULT TCSP_FlushSpecific_Common(UINT32, TPM_RESOURCE_TYPE);
	...
	TSS_RESULT TCSP_TakeOwnership_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
						...
						BYTE * srkInfo,	/*in */
						TCM_AUTH_SESSION * ownerAuth,	/* in, out */
	...
	TSS_RESULT TCSP_APCreate_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
		      TCPA_ENTITY_TYPE entityType,	/* in */
		      UINT32 entityValue,		/* in */
	...
	TSS_RESULT TCSP_APTerminate_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
		      	 TCS_AUTHHANDLE handle,		/* in */
			 TCPA_AUTHDATA inMac		/* in */
	);
