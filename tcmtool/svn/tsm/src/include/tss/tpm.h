...
#define TCM_ET_KEYDES		       ((UINT16)0x000d)
#define TCM_ET_OWNERAES		       ((UINT16)0x000e)
#define TCM_ET_OWNERDES		       ((UINT16)0x000f)
#define TCM_ET_KEYXOR		       ((UINT16)0x0010)
#define TCM_ET_KEYSMS4		       ((UINT16)0x0011)
...
#define TCM_ECCKEY_SIGNING             ((UINT16)0x0010)
#define TCM_ECCKEY_STORAGE             ((UINT16)0x0011)
#define TCM_ECCKEY_IDENTITY            ((UINT16)0x0012)
#define TCM_ECCKEY_AUTHCHANGE          ((UINT16)0x0013)
#define TCM_ECCKEY_BIND                ((UINT16)0x0014)
#define TCM_ECCKEY_LEGACY              ((UINT16)0x0015)
#define TCM_ECCKEY_PEK                 ((UINT16)0x0017)
...
#define	TCM_SS_NONE		       ((UINT16)0x0001)
...
#define TCM_ES_NONE		       ((UINT16)0x0004)
#define TCM_ES_SM2		       ((UINT16)0x0006)	    /* ecc */
