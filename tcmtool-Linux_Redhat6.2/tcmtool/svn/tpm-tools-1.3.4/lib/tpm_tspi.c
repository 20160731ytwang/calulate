...
// TCM algorithms
const char *algKdf = "KDF";
const char *algXor = "Xor";
const char *algSM2 = "SM2";
const char *algSMS4 = "SMS4";
const char *algSM3 = "SM3";
...
// TCM enc scheme
const char *encSM2 = "SM2";
const char *encSMS4CBC = "SMS4_CBC";
...
// 	}
	result = getAttribUint32(a_hKey, TSS_TSPATTRIB_RSAKEY_INFO, TSS_TSPATTRIB_KEYINFO_RSA_KEYSIZE, &uiAttr);
	if (result == TSS_SUCCESS)
		logMsg(_("  Key Size:          %d bits\n"), uiAttr);
