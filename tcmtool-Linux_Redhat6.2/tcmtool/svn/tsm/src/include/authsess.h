...
TSS_RESULT authsess_ap_init(TSS_HCONTEXT, TPM_ENTITY_TYPE, UINT32, TCM_AUTH_SESSION**);
TSS_RESULT authsess_ap_hmac(TCM_AUTH_SESSION *, TPM_DIGEST *);
TSS_RESULT authsess_ap_verify(TCM_AUTH_SESSION *, TPM_DIGEST *);
void       authsess_ap_free(TCM_AUTH_SESSION *);
