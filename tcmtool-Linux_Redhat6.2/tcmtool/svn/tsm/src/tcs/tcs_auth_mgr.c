...
TSS_RESULT
auth_mgr_APCreate(TCS_CONTEXT_HANDLE hContext,	/* in */
	      	  TCPA_ENTITY_TYPE entityType,	/* in */
		  UINT32 entityValue,		/* in */
		  ...
		  TCPA_AUTHDATA * outMac)	/* out */
{
	...
	if ((result = TCSP_APCreate_Internal(hContext, entityType, entityValue, callerNonce,
					     inMac, authHandle, nonceEven, seq, outMac)))
		goto done;
